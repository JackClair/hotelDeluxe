...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
   ...
   <section class="home-slider owl-carousel">
      <div class="slider-item" style="background-image:url(images/luxury_hotel.jpg);">
      	<div class="overlay"></div>
        <div class="container">
          <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-12 ftco-animate text-center">
          	<div class="text mb-5 pb-3" id="align-logo">
	            <h1 id="lblwelcome" class="mb-3">Welcome To Deluxe</h1>
	            <h2 id="h2-welcome">Hotels &amp; Resorts</h2>
            </div>
          </div>
          
        <section id="ipData" class="ftco-booking">
    	<div class="container">
    		<div class="row">
    			<div class="col-lg-12">
    				<form action="advancebooking.php" method="post" class="booking-form">
	        		<div class="row">
	        			<div class="col-md-3 d-flex">
	        				<div class="form-group p-4 align-self-stretch d-flex align-items-end">
	        					<div class="wrap">
				    					<label  id="lbllbl" for="#">Check-in Date</label>
				    					<input type="date" name="date"lass="form-control checkin_date" placeholder="Check-in date">
			    					</div>
			    				</div>
	        			</div>
	        			<div class="col-md-3 d-flex" style="border-radius: 10%">
	        				<div class="form-group p-4 align-self-stretch d-flex align-items-end">
	        					<div class="wrap">
				    					<label id = "lbllbl" for="#">Number of days</label>
				    					<input type="text" name="noofdays" class="form-control checkout_date" placeholder="Check-out date">
			    				</div>
			    				</div>
	        			</div>
	        			<div class="col-md d-flex">
	        				<div class="form-group p-4 align-self-stretch d-flex align-items-end">
	        					<div class="wrap">
			      					<label id="lbllbl" for="#">Room</label>
	        			...
	        			<div class="col-md d-flex">
	        				<div class="form-group p-4 align-self-stretch d-flex align-items-end">
	        					<div class="wrap">
			      					<label id="lbllbl" for="#">Customer</label>
			      					<div class="form-field">
			        					<div class="select-wrap">
			                    <div class="icon"><span class="ion-ios-arrow-down"></span></div>
	        			...
	        			<div class="col-md d-flex">
			              ...
			              <input type="submit" name="check" value="Check availability" id ="btn-chk"class="btn btn-primary py-3 px-4 align-self-stretch">
			            </div>
	        			</div>
	        		</div>
	        	</form>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/bg_2.jpg);">
						<a href="https://www.youtube.com/watch?v=UoIjjPqqnO0" class="icon popup-vimeo d-flex justify-content-center align-items-center">
    		...
    		<div class="row">
    			<div class="col-sm col-md-6 col-lg-4 ftco-animate">
    				<div class="room">
    					...
    					<div class="text p-3 text-center">
    						<h3 class="mb-3"><a href="roomdetail.html">Suite Room</a></h3>
    						<p><span class="price mr-2"><span>&#8377;</span>1200.00</span> <span class="per">per night</span></p>
    						<hr>
    			...
    			<div class="col-sm col-md-6 col-lg-4 ftco-animate">
    				<div class="room">
    					...
    					<div class="text p-3 text-center">
    						<h3 class="mb-3"><a href="roomdetail.html">Family Room</a></h3>
    						<p><span class="price mr-2"><span>&#8377;</span>2000.00</span> <span class="per">per night</span></p>
    						<hr>
    						<p class="pt-1"><a href="room-single.html" class="btn-custom">View Room Details <span class="icon-long-arrow-right"></span></a></p>
    					</div>
    				</div>
    			...
    			<div class="col-sm col-md-6 col-lg-4 ftco-animate">
    				<div class="room">
    					...
    					<div class="text p-3 text-center">
    						<h3 class="mb-3"><a href="roomdetail.html">Deluxe Room</a></h3>
    						<p><span class="price mr-2"><span>&#8377;</span>2500.00</span> <span class="per">per night</span></p>
    						<hr>
    						<p class="pt-1"><a href="room-single.html" class="btn-custom">View Room Details <span class="icon-long-arrow-right"></span></a></p>
    					</div>
    				</div>
